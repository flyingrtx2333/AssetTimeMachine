...
nonisolated struct DayKHighSpeed004Bar {
    let open: Double
    let high: Double
    let low: Double
    let close: Double
...
nonisolated struct DayKHighSpeed004Signal {
...
nonisolated enum DayKHighSpeed004Logic {
