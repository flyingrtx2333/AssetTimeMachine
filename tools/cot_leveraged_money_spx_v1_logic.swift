...
nonisolated enum COTLeveragedMoneySPXV1Logic {
    struct Point: Equatable {
        let reportDate: String
        let availableDate: String
        let deltaNetLongShare: Double
    }
    ...
    static func latestRiskOn(
        ...
        var latest: Point?
        for point in points {
            guard point.deltaNetLongShare.isFinite else { continue }
        ...
        return point.deltaNetLongShare > 0
    }
