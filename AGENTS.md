...
- Latest TestFlight release: version `1.12` build `167`, Delivery UUID `ba0cdb09-73b4-49bf-a5f5-df8196b5271c`, App Store Connect status `BUILD-STATUS: VALID`, artifact directory `build/TestFlight-1.12-167`.
