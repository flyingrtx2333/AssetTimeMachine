...
- Latest TestFlight release: version `1.12` build `172`, Delivery UUID `7780b84f-ad3d-450a-8390-cd1fad804425`, App Store Connect status `BUILD-STATUS: VALID`, artifact directory `build/TestFlight-1.12-172`.
