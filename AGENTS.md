...
- Latest TestFlight release: version `1.12` build `171`, Delivery UUID `a84f1482-6ffd-42c1-9675-52a93b91f1ab`, App Store Connect status `BUILD-STATUS: VALID`, artifact directory `build/TestFlight-1.12-171`.
