...
- Latest TestFlight release: version `1.12` build `164`, Delivery UUID `53352df1-b0d0-4018-a753-766d9ffc96f6`, App Store Connect status `BUILD-STATUS: VALID`, artifact directory `build/TestFlight-1.12-164`.
