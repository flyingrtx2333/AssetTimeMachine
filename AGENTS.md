...
- Latest TestFlight release: version `1.10` build `156`, Delivery UUID `2c7638e8-08b5-4505-8cbe-88030dde6e4f`, App Store Connect status `BUILD-STATUS: VALID`, artifact directory `build/TestFlight-1.10-156`.
