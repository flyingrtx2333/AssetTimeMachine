...
- Latest TestFlight release: version `1.12` build `173`, Delivery UUID `9f7045a5-e9d7-4a27-800f-0b89ec63259f`, App Store Connect status `BUILD-STATUS: VALID`, artifact directory `build/TestFlight-1.12-173`.
