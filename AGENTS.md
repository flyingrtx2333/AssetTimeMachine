...
- Latest TestFlight release: version `1.12` build `174`, Delivery UUID `a83c73eb-8db6-48a6-8df2-ab3ba9898da5`, App Store Connect status `BUILD-STATUS: VALID`, artifact directory `build/TestFlight-1.12-174`.
