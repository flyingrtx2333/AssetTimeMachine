...
- Latest TestFlight release: version `1.12` build `176`, Delivery UUID `cf5e7831-25f9-468a-8fc3-c91e670505d3`, App Store Connect status `BUILD-STATUS: VALID`, artifact directory `build/TestFlight-1.12-176`.
