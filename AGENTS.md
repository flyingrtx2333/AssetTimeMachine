...
- Latest TestFlight release: version `1.12` build `170`, Delivery UUID `3d0b9f59-17ee-4a6b-a5e1-7aa4279efa2f`, App Store Connect status `BUILD-STATUS: VALID`, artifact directory `build/TestFlight-1.12-170`.
