...
- Latest TestFlight release: version `1.12` build `168`, Delivery UUID `76addcf5-9c28-43f0-8a25-32cb301cd25d`, App Store Connect status `BUILD-STATUS: VALID`, artifact directory `build/TestFlight-1.12-168`.
