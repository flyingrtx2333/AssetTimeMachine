...
- Latest TestFlight release: version `1.12` build `162`, Delivery UUID `5fc19796-1b99-4d2a-bf94-be9f6c6ae1db`, App Store Connect status `BUILD-STATUS: VALID`, artifact directory `build/TestFlight-1.12-162`.
