...
- Latest TestFlight release: version `1.12` build `175`, Delivery UUID `a49591bb-204c-41b6-9e3a-4b2c77a6d122`, App Store Connect status `BUILD-STATUS: VALID`, artifact directory `build/TestFlight-1.12-175`.
