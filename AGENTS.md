...
- Latest TestFlight release: version `1.12` build `183`, Delivery UUID `19ec0c3e-b59e-420a-9fac-d07fd27fc2c2`, App Store Connect status `BUILD-STATUS: VALID`, artifact directory `build/TestFlight-1.12-183`.
