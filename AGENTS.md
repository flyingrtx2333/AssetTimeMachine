...
- Latest TestFlight release: version `1.12` build `189`, Delivery UUID `ed4cb688-2f5f-4aad-bc58-bc690ea365f7`, App Store Connect status `BUILD-STATUS: VALID`, artifact directory `build/TestFlight-1.12-189`.
...
- Previous TestFlight release: version `1.12` build `188`, Delivery UUID `b8973fd1-024b-49e7-8096-689fee6b6d73`, App Store Connect status `BUILD-STATUS: VALID`, artifact directory `build/TestFlight-1.12-188`.
