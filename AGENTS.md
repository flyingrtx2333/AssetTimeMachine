...
- Latest TestFlight release: version `1.12` build `177`, Delivery UUID `415c2566-266e-451c-9fa7-d408ab68b953`, App Store Connect status `BUILD-STATUS: VALID`, artifact directory `build/TestFlight-1.12-177`.
