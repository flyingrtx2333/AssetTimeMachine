...
- Latest TestFlight release: version `1.10` build `155`, Delivery UUID `92980223-394d-4d3b-a0ba-493ab61b6de6`, App Store Connect status `BUILD-STATUS: VALID`, artifact directory `build/TestFlight-1.10-155`.
