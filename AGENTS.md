...
- Latest TestFlight release: version `1.12` build `165`, Delivery UUID `67c124fa-f463-49e1-8f1c-6551be580b27`, App Store Connect status `BUILD-STATUS: VALID`, artifact directory `build/TestFlight-1.12-165`.
