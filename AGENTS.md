...
- Latest TestFlight release: version `1.12` build `169`, Delivery UUID `aa3c73be-c128-484b-9787-6bac77001a13`, App Store Connect status `BUILD-STATUS: VALID`, artifact directory `build/TestFlight-1.12-169`.
