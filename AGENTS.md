...
- Latest TestFlight release: version `1.12` build `184`, Delivery UUID `e890357c-ce3e-4516-a011-3872266ac710`, App Store Connect status `BUILD-STATUS: VALID`, artifact directory `build/TestFlight-1.12-184`.
