#!/usr/bin/env python3
"""Fetch raw inputs for ATM-SVP2 Orthogonal Factor Family V2.

This module performs source retrieval and provenance capture only. It does not calculate factor-conditioned
returns, portfolio returns, Sharpe, drawdown, or any candidate-selection statistic.
"""
...
USER_AGENT = "AssetTimeMachine-OrthogonalFactorV2/1.0"
