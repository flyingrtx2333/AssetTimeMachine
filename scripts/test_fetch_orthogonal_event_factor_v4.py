...
from fetch_orthogonal_event_factor_v4 import ALLOWED_SOURCES, parse_yahoo_adjusted_chart


class OrthogonalEventFactorV4FetchTests(unittest.TestCase):
    ...
    def test_parser_uses_adjusted_close_not_raw_close(self) -> None:
        payload = {
            "chart": {
                ...
                "result": [{
                    ...
                    "meta": {"instrumentType": "ETF", "exchangeName": "PCX", "currency": "USD"},
                }],
            }
        }
        ...
        self.assertEqual(meta["exchange_name"], "PCX")
