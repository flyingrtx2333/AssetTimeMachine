...
from run_orthogonal_factor_family_v1 import FORMAL_CANDIDATES, evaluate_factor


class OrthogonalFactorFamilyV1Tests(unittest.TestCase):
    def test_formal_candidates_are_exactly_preregistered_three(self) -> None:
        self.assertEqual(FORMAL_CANDIDATES, ["F-CURVE", "F-USD", "F-SIZE"])

    def test_factor_is_admitted_only_when_it_beats_v11_cagr_and_always_fill_sharpe(self) -> None:
        metrics = {
            "cagr_percent": 15.6,
            "sharpe": 1.56,
            "mdd_percent": 9.0,
    ...
    def test_factor_with_more_cagr_but_worse_sharpe_than_always_fill_is_rejected(self) -> None:
        metrics = {
            "cagr_percent": 17.0,
            "sharpe": 1.30,
            "mdd_percent": 10.0,
    ...
    def test_factor_needs_at_least_four_fold_wins_vs_always_fill(self) -> None:
        metrics = {
            "cagr_percent": 15.6,
            "sharpe": 1.56,
            "mdd_percent": 9.0,
