...
from run_orthogonal_event_factor_v4 import FORMAL_CANDIDATES, MATCHED_CONTROLS, evaluate_factor


class OrthogonalEventFactorV4Tests(unittest.TestCase):
    def test_candidate_and_control_mapping_is_frozen(self) -> None:
        self.assertEqual(FORMAL_CANDIDATES, ["F-HIGHBETA", "F-INDUTIL", "F-BANKS"])
        self.assertEqual(
            MATCHED_CONTROLS,
            {
