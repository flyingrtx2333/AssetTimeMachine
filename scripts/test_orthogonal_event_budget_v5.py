...
from run_orthogonal_event_budget_v5 import FORMAL_CANDIDATES, MATCHED_CONTROLS, evaluate_factor


class OrthogonalEventBudgetV5Tests(unittest.TestCase):
    def test_candidate_and_control_mapping_is_frozen(self) -> None:
        self.assertEqual(FORMAL_CANDIDATES, ["F-GROWTHBOND", "F-BIOTECH", "F-TRANSPORT"])
        self.assertEqual(
            MATCHED_CONTROLS,
            {
